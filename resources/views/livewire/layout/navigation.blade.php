    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-slate-200 dark:border-slate-700">
            ...
            <div class="mt-3 space-y-1">
                ...
                <!-- Authentication -->
                <button wire:click="logout" class="w-full text-left block pl-3 pr-4 py-2 text-base font-medium text-slate-600 dark:text-slate-400 hover:text-slate-800 dark:hover:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-700 focus:outline-none transition duration-150 ease-in-out">
                    {{ __('Log Out') }}
                </button>
            </div>
        </div>
