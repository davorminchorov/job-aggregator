...
<body class="h-full antialiased">
    <div class="min-h-full bg-gradient-to-br from-violet-50 to-violet-100 dark:from-slate-900 dark:to-slate-800 px-4 py-16 sm:px-6 sm:py-24 md:grid md:place-items-center lg:px-8">
        <div class="max-w-max mx-auto">
            <main class="sm:flex">
                <p class="text-4xl font-bold tracking-tight text-violet-600 dark:text-violet-400 sm:text-5xl">419</p>
                <div class="sm:ml-6">
                    <div class="sm:border-l sm:border-slate-200 dark:sm:border-slate-700 sm:pl-6">
                        <h1 class="text-4xl font-bold tracking-tight text-slate-900 dark:text-white sm:text-5xl">Page Expired</h1>
                        <p class="mt-3 text-base text-slate-600 dark:text-slate-400">Sorry, your session has expired. Please refresh and try again.</p>
                    </div>
